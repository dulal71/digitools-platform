...
const Rating = () => {
    return (
        ...
        <div className= 'max-w-7xl mx-auto flex  items-center justify-center p-10 md:p-15'>
          ...
          <div  className=' text-center  border-r border-white  px-5  md:px-24'>
            <span className='text-3xl md:text-5xl font-bold text-white'>200+</span>
            <p className='font-medium text-6 text-white mt-2'>Premium Tools</p>
          </div>
          <div className='text-center '>
            <span className='text-3xl md:text-5xl font-bold text-white px-5 md:px-24'>
             4.9
            </span>
